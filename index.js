...
try {
    ...
    const contact5 = new Contact("David", "Williams", "1415 Blvd", "Chicago", "Illinois", "60601", "9222334455", "david@example.com");
...
// Sort by City and display
personalBook.sortByCity();
console.log("\nSorted by City:");
personalBook.displayContacts();

// Sort by State and display
personalBook.sortByState();
console.log("\nSorted by State:");
personalBook.displayContacts();

// Sort by Zip and display
personalBook.sortByZip();
console.log("\nSorted by Zip:");
personalBook.displayContacts();
